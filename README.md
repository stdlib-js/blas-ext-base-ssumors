...
```javascript
import ssumors from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssumors@v0.0.9-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ssumors/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/blas-ext-base-ssumors/actions/workflows/test.yml?query=branch:v0.0.9
