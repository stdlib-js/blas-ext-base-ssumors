...
```javascript
import ssumors from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssumors@v0.3.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ssumors/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-ssumors/actions/workflows/test.yml?query=branch:v0.3.1
